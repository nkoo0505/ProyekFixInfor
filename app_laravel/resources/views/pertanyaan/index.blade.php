...
@section('content')
{{-- 
    NOTE: Background diatur via <style> di bawah agar full screen & tegas.
    Div ini hanya wrapper konten.
--}}
    ...
    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama" class="form-control bg-light border-0 py-2" placeholder="Anonim">
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label fw-bold small text-uppercase" style="color: #004b93;">Aspirasi / Pertanyaan</label>
                                <textarea name="isi" class="form-control bg-light border-0" rows="3" required placeholder="Tuliskan pendapat atau pertanyaanmu di sini..."></textarea>
                            </div>
                        </div>
                        <div class="text-end">
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-lg-6 text-center">
                {{-- Teks Putih karena berada di area Biru --}}
        ...
        <div class="aspirasi-grid">
            @forelse($pendapats as $pendapat)
                <div class="aspirasi-card bg-white shadow rounded-4 overflow-hidden position-relative" 
                     style="height: 320px; transition: transform 0.3s ease;">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div class="d-flex align-items-center gap-2">
                                <div class="rounded-circle d-flex align-items-center justify-content-center text-white" 
                                     style="width: 40px; height: 40px; background-color: #004b93;">
                    ...
                    <div class="admin-reply-overlay position-absolute top-0 start-0 w-100 h-100 p-4 d-flex flex-column justify-content-center text-white text-center"
                        ...
                        <div class="mb-3">
                            {{-- Lingkaran Putih dengan Icon Orang --}}
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-2">
                            <span class="badge bg-white rounded-pill px-3 py-2 fw-normal shadow-sm" style="color: #004b93;">
                                ...
                                ({{ $pendapat->balasan->ormawa->nama_ormawa ?? 'ORMAWA' }})
                            </span>
                        </div>
                    </div>
                    @endif
            ...
            @empty
                {{-- 
                    INI ADALAH BAGIAN 'EMPTY STATE' (KOSONG).
                    Class 'empty-state-full-width' akan membuatnya mengambil seluruh lebar grid.
                --}}
...
<style>
    ...
    /* TRIK AGAR PESAN KOSONG MENJADI FULL WIDTH (TENGAH)
       Kita suruh elemen ini mengambil kolom dari baris ke-1 sampai terakhir (-1)
    */
    .empty-state-full-width {
        ...
        min-height: 300px; /* Supaya tidak terlalu gepeng */
    }
